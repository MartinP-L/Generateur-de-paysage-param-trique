...
void Svgfile::addQuadrilatere(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4, std::string colorFill)
{
    //création de deux triangles pour faire un rectangle
    m_ostrm << "<polygon points=\" "
            << x1 << "," << y1 << " "
            << x2 << "," << y2 << " "
            << x3 << "," << y3 << " "
...
void Svgfile::addQuadrilatereTrait(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4, std::string colorFill)
{
    //création de deux triangles pour faire un rectangle
    m_ostrm << "<polygon points=\" "
            << x1 << "," << y1 << " "
