...
{
    public:
        Svgfile(std::string _filename = "output.svg", int _width=1400, int _height=1000);
        ~Svgfile();

        //fonction traçage rectangle :
        void addQuadrilatere(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4, std::string colorFill);
        void addQuadrilatereTrait(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4, std::string colorFill);
